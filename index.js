...
const dizi = sonCesitiKaldir(orijinalTatlar);
console.log(dizi);
...
const indeks2Cesni = indekstekiCesitiGetir(orijinalTatlar, 2);
console.log(indeks2Cesni);
...
function ismeGoreCesitCikar(tatlar, lezzetAdi) {
  const indeks = tatlar.indexOf(lezzetAdi);
...
const yeniTatlar = ismeGoreCesitCikar(orijinalTatlar, "Tarçın");
console.log(yeniTatlar.length);
